...
public class executingRefresher extends TimerTask
{
    Label completedLabel;

    public executingRefresher(Label completedLabel)
    {
    ...
    public void run()
    {
        String serverUrl = "http://localhost:8080/get_exec_tasks"; // Example URL
