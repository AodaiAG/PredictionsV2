...
public class waitingRefreshers extends TimerTask

{

    Label completedLabel;

    public waitingRefreshers(Label completedLabel)
    {
    ...
    public void run()
    {
        String serverUrl = "http://localhost:8080/get_waiting_tasks"; // Example URL
