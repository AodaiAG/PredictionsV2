...
public class ThreadPoolSizeRefresher extends TimerTask
{

    Label completedLabel;

    public ThreadPoolSizeRefresher(Label completedLabel)
    {
    ...
    public void run()
    {
        String serverUrl = "http://localhost:8080/get_thread_pool_size"; // Example URL
