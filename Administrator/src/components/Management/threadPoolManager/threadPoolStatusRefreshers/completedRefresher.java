...
public class completedRefresher  extends TimerTask
{
    Label completedLabel;

    public completedRefresher(Label completedLabel)
    {
    ...
    public void run()
    {
        String serverUrl = "http://localhost:8080/get_completed_tasks"; // Example URL
