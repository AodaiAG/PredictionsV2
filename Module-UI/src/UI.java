...
//    public void environmentInitByUser(List<EnvironmentDTO> eDTOList, Printer pr)
//    {
//        Scanner sc = new Scanner(System.in);
//        int userChoiceEnvFromList;
//
//        int i = 0;
//        System.out.println('\n' + "** Environment Variables **: ");
//        for (EnvironmentDTO environmentDTO : eDTOList)
//        {
...
//        String userChoiceEnvFromListString;
//
//        while (!finished)
//        {
//            System.out.println("Please enter a number of a variable you wish to init (0 if you're done): ");
//            userChoiceEnvFromListString = sc.next();
//            if (userChoiceEnvFromListString.matches("\\d+"))
//            {
//                userChoiceEnvFromList = Integer.parseInt(userChoiceEnvFromListString);
//                if (userChoiceEnvFromList == 0)
//                {
//                    finished =true;
//                } else if (userChoiceEnvFromList >= 1 && userChoiceEnvFromList <= eDTOList.size())
//                {
//                    boolean isEnteredDataValid = false;
//                    while (!isEnteredDataValid)
//                    {
//                        String chosenTypeToInit = eDTOList.get(userChoiceEnvFromList - 1).getEnProperty().getNameOfDataType();
...
//                        try
//                        {
//                            this.engine.setDataToEnvironmentVar(eDTOList.get(userChoiceEnvFromList - 1), enteredData);
...
//    }
    ...
    public void environmentInitByUser(List<EnvironmentDTO> eDlist, Printer pr) {
        ...
        while (!finished) {
            System.out.println("Please enter a number of a variable you wish to init (0 if you're done): ");
            int userChoiceEnvFromList = getUserChoice(sc, eDlist.size());
    ...
    private int getUserChoice(Scanner sc, int maxChoice) {
        int userChoice = 0;
