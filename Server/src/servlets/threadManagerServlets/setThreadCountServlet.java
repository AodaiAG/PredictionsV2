...
@WebServlet(name = "setThreadCountServlet",urlPatterns = "/set_thread_count")
public class setThreadCountServlet  extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            threadPoolManager.initThreadPool(number);
            resp.getWriter().print("Thread Pool initialized successfully.");
        }
        catch (Exception e)
        {
